 ...
 * Date: 28/03/14
 */
public class TestTaxYearSummaryService extends AbstractSpringAwareBase {
    @Test
    public void testTaxYearSummary() {
        Employee employee = fakeDataService.createEmployeeAndTimeSheets();
        for (Object obj : taxYearSummaryService.getTaxYearSummary(employee)) {
